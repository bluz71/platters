...
RSpec.describe "User Update API" do
  ...
  it "with name taken" do
    FactoryBot.create(:user, email: "fred1@example.com",
                      password: "password9", name: "fred1")
    user = FactoryBot.create(:user, email: "fred@example.com",
                             password: "password9", name: "fred")
  ...
  it "with mismatch authenticity" do
    user1 = FactoryBot.create(:user, email: "fred1@example.com",
                              password: "password9", name: "fred1")
    user2 = FactoryBot.create(:user, email: "fred2@example.com",
                              password: "password9", name: "fred2")
